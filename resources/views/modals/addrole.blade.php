<div class="modal fade" id="modal_add_role" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				<a class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></a>
				<h4 class="modal-title" id="myModalLabel">Tambah User Role</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal form-label-left" action="{{ route('PostUserRole') }}" method="POST">
					<div class="form-group margin-40">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          	 <input id="role_add_name" type="text" name="role_add_name" class="form-control" placeholder="Role Name" required autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group margin-40">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        	<div class="checkbox">
	                        	<label>
	                        		<input id="PIC" type="checkbox" name="PIC" class="flat" value="1">
	                        	</label>
                        	</div>
                        </div>
                    </div>					
                    <div class="form-group margin-40">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        	<div class="checkbox">
	                        	<label>
	                        		<input id="head" type="checkbox" name="head" class="flat" value="1">
	                        	</label>
                        	</div>
                        </div>
                    </div>					
