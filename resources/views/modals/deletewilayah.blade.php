<div class="modal modal-konfirmasi fade" id="modal_deletewilayah" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form class="form-horizontal form-label-left" enctype="multipart/form-data" action="{{ route('EditWilayah') }}" method="POST">
			<div class="modal-body">
				...
				<div class="row">
	                <div class="col-md-12 col-sm-12 col-xs-12">
                    	<input type="hidden" id='delete_wilayah_id' name="wilayah_id">
