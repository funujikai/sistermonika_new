<div class="modal modal-konfirmasi fade" id="modal_deletepn" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form class="form-horizontal form-label-left" enctype="multipart/form-data" action="{{ url('deletePN') }}" method="POST">
